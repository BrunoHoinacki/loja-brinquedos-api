<template>
    <div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
        <form @submit.prevent="login" class="bg-white p-8 rounded shadow-md w-full max-w-md space-y-4">
            ...
            <input v-model="username" type="text" placeholder="Usuário" class="w-full border px-3 py-2 rounded"
                required />
            <input v-model="password" type="password" placeholder="Senha" class="w-full border px-3 py-2 rounded"
                required />
